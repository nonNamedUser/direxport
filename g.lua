...
task.spawn(function()
	while task.wait() do
		if cc == "p" then
			...
			if p then
				me.Character:WaitForChild("HumanoidRootPart").Position=p.Character:WaitForChild("HumanoidRootPart").Position
			end
		else
			me.Character:WaitForChild("HumanoidRootPart").Position=pos
		end
	end
end)
